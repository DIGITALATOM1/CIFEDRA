...
console.log("[next] Run npm run local:restart so the API picks up Chatwoot settings.");
console.log("[safe default] External writes remain disabled until both live flags are set to 1.");

function buildCifedraEnv(result, baseUrl) {
  return [
    "# Generated by npm run integrations:chatwoot:bootstrap. Do not commit.",
    "CIFEDRA_INTEGRATIONS_LIVE=0",
    "CIFEDRA_ALLOW_EXTERNAL_WRITES=0",
